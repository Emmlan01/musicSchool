...
ALTER TABLE lesson_types ADD CONSTRAINT PK_lesson_types PRIMARY KEY (lesson_id,group_lesson_id,ensemble_id);
...
ALTER TABLE lesson_schedule ADD CONSTRAINT FK_lesson_schedule_2 FOREIGN KEY (individual_lesson_id) REFERENCES individual_lesson (individual_lesson_id);


ALTER TABLE lesson_types ADD CONSTRAINT FK_lesson_types_0 FOREIGN KEY (lesson_id) REFERENCES lesson_schedule (lesson_id);
ALTER TABLE lesson_types ADD CONSTRAINT FK_lesson_types_1 FOREIGN KEY (group_lesson_id) REFERENCES group_lesson (group_lesson_id);
ALTER TABLE lesson_types ADD CONSTRAINT FK_lesson_types_2 FOREIGN KEY (ensemble_id) REFERENCES ensemble (ensemble_id);
